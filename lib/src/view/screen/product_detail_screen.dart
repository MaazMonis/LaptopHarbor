...
import 'package:laptopharbor/src/view/widget/page_wrapper.dart';
import 'package:laptopharbor/src/view/widget/carousel_slider.dart';
...
class ProductDetailScreen extends StatelessWidget {
  ...
  const ProductDetailScreen(this.product, {Key? key});
